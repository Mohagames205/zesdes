...
<div>
    ...
    <div class="bg-gray-200 bg-opacity-25">
        ...
        @if(count($photos) > 0)
            <div class="bg-gray-200 bg-opacity-25 flex flex-wrap gap-4 p-6 justify-center">
                @foreach($photos as $photo)
                    <div>
                        <img class="rounded transition ease-in-out flex-shrink " width="300px" src="{{ $photo->temporaryUrl() }}" alt="geuploade foto">
                        ...
                        @error('photos.*') oops something went wong @enderror
                    </div>
                @endforeach
            </div>
        @endif
